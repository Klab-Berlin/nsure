...
Nsure.helpers.dateNsure = function(date, fallbackValue) {
	if (typeof fallbackValue === 'undefined') {
...
Nsure.helpers.boolNsure = function(fallbackValue, enforcePresence) {
	if (typeof fallbackValue !== 'boolean') {
		fallbackValue = true;
	}
	if (typeof enforcePresence !== 'boolean') {
		enforcePresence = true;
	}
	var nsureRules = {		
		enforcePresence: enforcePresence,
		defaultTo: fallbackValue,
		checks: [ 'type' ],
		type: {
			expected: 'boolean',
...
Nsure.helpers.arrayOfNsure = function(typeArray, valueArray, fallbackValue) {
	var nsureRules = {		
		enforcePresence: true,
		defaultTo: fallbackValue,
...
Nsure.helpers.mongoidNsure = function(enforcePresence) {
	if (typeof enforcePresence !== 'boolean') {
