...
// ---[[[ mongoId
aNsure.prototype.checks.mongoId = function(input, options, thisAttribute, fullInput, fullRules) {
...
aNsure.prototype.checks.mongoIdArray = function(input, options, thisAttribute, fullInput, fullRules) {
	var self = this;
...
aNsure.prototype.checks.mongoId.returnError = function(input, options, thisAttribute, fullInput, fullRules) {
  var error = new aError(options.error.code, options.error.msg, input);
	return error;
};
aNsure.prototype.checks.mongoIdArray.returnError = function(input, options, thisAttribute, fullInput, fullRules) {
  var error = new aError(options.error.code, options.error.msg, input);
	return error;
};
...
aNsure.prototype.checks.subNsure = function(input, options, thisAttribute, fullInput, fullRules) {
...
// ---[[[ type
aNsure.prototype.checks.type = function(input, options, thisAttribute, fullInput, fullRules) {
...
aNsure.prototype.checks.type.toNumber = function(input, options, thisAttribute, fullInput, fullRules) {
...
aNsure.prototype.checks.type.toInt = function(input, options, thisAttribute, fullInput, fullRules) {
	var aInt = parseInt(input);
	if (isNaN(aInt)) aInt = this.toNumber.toFallback(input, options, thisAttribute, fullInput, fullRules);
	return aInt;
};
aNsure.prototype.checks.type.toNumber.toFallback = function(input, options, thisAttribute, fullInput, fullRules) {
...
aNsure.prototype.checks.type.toString = function(input, options, thisAttribute, fullInput, fullRules) {
	var aString = String(input);
	return aString;
};
aNsure.prototype.checks.type.toBoolean = function(input, options, thisAttribute, fullInput, fullRules) {
	var aBoolean = Boolean(input);
	if(typeof aBoolean !== 'boolean') aBoolean = true;
	return aBoolean;
};
aNsure.prototype.checks.type.toFallback = function(input, options, thisAttribute, fullInput, fullRules) {
	return (typeof options.fallback === 'function') ? options.fallback(input, options, thisAttribute, fullInput, fullRules) : options.fallback;
};
aNsure.prototype.checks.type.returnError = function(input, options, thisAttribute, fullInput, fullRules) {
	var error = new aError(options.error.code, options.error.msg, input);
	return error;
};
...
// ---[[[ regEx
aNsure.prototype.checks.regEx = function(input, options, thisAttribute, fullInput, fullRules) {	
...
aNsure.prototype.checks.regEx.toFallback = function(input, options, thisAttribute, fullInput, fullRules) {
	return (typeof options.fallback === 'function') ? options.fallback(input, options, thisAttribute, fullInput, fullRules) : options.fallback;
};
aNsure.prototype.checks.regEx.returnError = function(input, options, thisAttribute, fullInput, fullRules) {
	var error = new aError(options.error.code, options.error.msg, input);
	return error;
};
...
// ---[[[ email
aNsure.prototype.checks.email = function(input, options, thisAttribute, fullInput, fullRules) {
...
aNsure.prototype.checks.email.returnError = function(input, options, thisAttribute, fullInput, fullRules) {
	var error = new aError(options.error.code, options.error.msg, input);
	return error;
};
...
// ---[[[ replace
aNsure.prototype.checks.replace = function(input, options, thisAttribute, fullInput, fullRules) {	
	return input.replace(options.query, options.replacement);
};


// ---[[[ numberRange
aNsure.prototype.checks.numberRange = function(input, options, thisAttribute, fullInput, fullRules) {	
...
aNsure.prototype.checks.numberRange.toBorder = function(input, options, thisAttribute, fullInput, fullRules) {
	if (input < options.min) return options.min;
	return options.max;
};
aNsure.prototype.checks.numberRange.toFallback = function(input, options, thisAttribute, fullInput, fullRules) {
	return (typeof options.fallback === 'function') ? options.fallback(input, options, thisAttribute, fullInput, fullRules) : options.fallback;
};
aNsure.prototype.checks.numberRange.returnError = function(input, options, thisAttribute, fullInput, fullRules) {
	var error = new aError(options.error.code, options.error.msg, input);
	return error;
};
...
// ---[[[ stringMaxLength
aNsure.prototype.checks.stringMaxLength = function(input, options, thisAttribute, fullInput, fullRules) {	
	if (input.length > options.max)	return this.stringMaxLength[options.onFail](input, options, thisAttribute, fullInput, fullRules);
	return input;
};
aNsure.prototype.checks.stringMaxLength.cut = function(input, options, thisAttribute, fullInput, fullRules) {
	if (input.length > options.max) return input.substr(0, options.max);
	return options.max;
};
aNsure.prototype.checks.stringMaxLength.returnError = function(input, options, thisAttribute, fullInput, fullRules) {
	var error = new aError(options.error.code, options.error.msg, input);
	return error;
};
...
// ---[[[ stringMinLength
aNsure.prototype.checks.stringMinLength = function(input, options, thisAttribute, fullInput, fullRules) {	
	if (input.length < options.min)	return this.stringMinLength[options.onFail](input, options, thisAttribute, fullInput, fullRules);
	return input;
};
aNsure.prototype.checks.stringMinLength.returnError = function(input, options, thisAttribute, fullInput, fullRules) {
	var error = new aError(options.error.code, options.error.msg, input);
	return error;
};
