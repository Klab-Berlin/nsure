...
aEnsure.prototype.createModel = function() {
	var model = {};
		...
		if (typeof attr.defaultTo === 'undefined') {
			if (typeof attr.type === 'object' && typeof attr.type.expected === 'string') {
				if (attr.type.expected.toLowerCase() === 'string') {
					...
					model[key] = {};
					if (typeof attr.deepEnsure === 'object') {
						// console.log('!!!!');
						var deepEnsure = new aEnsure(attr.deepEnsure);
						// console.log(deepEnsure.model);
						model[key] = deepEnsure.model;
					}
...
// ---[[[ check loop
aEnsure.prototype.check = function(input) {
	for (var n in input) {
...
aEnsure.prototype.returnError = function(error) {
	return error;
};
aEnsure.prototype.returnErrorMsg = function(error) {
	return error.msg;
};
aEnsure.prototype.returnErrorCode = function(error) {
	return error.code;
};


// ---[[[ supplied checks
aEnsure.prototype.checks = {};


// ---[[[ delete
aEnsure.prototype.checks.deleteAttribute = function(input, key, rules) {
	delete input[key];
	return input;
};
...
// ---[[[ mongoId
aEnsure.prototype.checks.mongoId = function(input, options, fullInput, fullRules) {
...
aEnsure.prototype.checks.mongoIdArray = function(input, options, fullInput, fullRules) {
	var self = this;
...
aEnsure.prototype.checks.mongoId.toFallback = function(input, options) {
	return new ObjectID();
};
aEnsure.prototype.checks.mongoId.returnError = function(input, options, fullInput, fullRules) {
  var error = new aError(options.error.code, options.error.msg, input);
	return error;
};
aEnsure.prototype.checks.mongoIdArray.returnError = function(input, options, fullInput, fullRules) {
  var error = new aError(options.error.code, options.error.msg, input);
	return error;
};
...
aEnsure.prototype.checks.deepEnsure = function(input, options, fullInput, fullRules) {
	var deepEnsure = new aEnsure(options);
	// console.log('----- DEEP ENSURE in ---');
	// console.log(options);
	// console.log(input);
	var result = deepEnsure.check(input);
...
// ---[[[ type
aEnsure.prototype.checks.type = function(input, options, fullInput, fullRules) {
	// console.log(typeof input, input);
	if (typeof input === options.expected) return input;
	return this.type[options.onFail](input, options, fullInput, fullRules);
};
aEnsure.prototype.checks.type.toNumber = function(input, options, fullInput, fullRules) {
	var aNumber = Number(input);
	if (isNaN(aNumber)) aNumber = this.checks.type.toNumber.toFallback(input, options, fullInput, fullRules);
	return aNumber;
};
aEnsure.prototype.checks.type.toInt = function(input, options, fullInput, fullRules) {
	var aInt = parseInt(input);
	if (isNaN(aInt)) aInt = this.toNumber.toFallback(input, options, fullInput, fullRules);
	return aInt;
};
aEnsure.prototype.checks.type.toNumber.toFallback = function(input, options, fullInput, fullRules) {
	return (typeof options.fallback === 'function') ? options.fallback(input, options, fullInput, fullRules) : options.fallback;
};
aEnsure.prototype.checks.type.toString = function(input, options, fullInput, fullRules) {
	var aString = String(input);
	return aString;
};
aEnsure.prototype.checks.type.toBoolean = function(input, options, fullInput, fullRules) {
	var aBoolean = Boolean(input);
	if(typeof aBoolean !== 'boolean') aBoolean = true;
	return aBoolean;
};
aEnsure.prototype.checks.type.toFallback = function(input, options, fullInput, fullRules) {
	return (typeof options.fallback === 'function') ? options.fallback(input, options, fullInput, fullRules) : options.fallback;
};
aEnsure.prototype.checks.type.returnError = function(input, options, fullInput, fullRules) {
	var error = new aError(options.error.code, options.error.msg, input);
	return error;
};
...
// ---[[[ regEx
aEnsure.prototype.checks.regEx = function(input, options, fullInput, fullRules) {	
...
aEnsure.prototype.checks.regEx.toFallback = function(input, options, fullInput, fullRules) {
	return (typeof options.fallback === 'function') ? options.fallback(input, options, fullInput, fullRules) : options.fallback;
};
aEnsure.prototype.checks.regEx.returnError = function(input, options, fullInput, fullRules) {
	var error = new aError(options.error.code, options.error.msg, input);
	return error;
};
...
// ---[[[ email
aEnsure.prototype.checks.email = function(input, options, fullInput, fullRules) {
...
aEnsure.prototype.checks.email.returnError = function(input, options, fullInput, fullRules) {
	var error = new aError(options.error.code, options.error.msg, input);
	return error;
};
...
// ---[[[ replace
aEnsure.prototype.checks.replace = function(input, options, fullInput, fullRules) {	
	return input.replace(options.query, options.replacement);
};


// ---[[[ numberRange
aEnsure.prototype.checks.numberRange = function(input, options, fullInput, fullRules) {	
	if (input < options.min || input > options.max)	return this.numberRange[options.onFail](input, options, fullInput, fullRules);
	return input;
};
aEnsure.prototype.checks.numberRange.toBorder = function(input, options, fullInput, fullRules) {
	if (input < options.min) return options.min;
	return options.max;
};
aEnsure.prototype.checks.numberRange.toFallback = function(input, options, fullInput, fullRules) {
	return (typeof options.fallback === 'function') ? options.fallback(input, options, fullInput, fullRules) : options.fallback;
};
aEnsure.prototype.checks.numberRange.returnError = function(input, options, fullInput, fullRules) {
	var error = new aError(options.error.code, options.error.msg, input);
	return error;
};
...
// ---[[[ stringMaxLength
aEnsure.prototype.checks.stringMaxLength = function(input, options, fullInput, fullRules) {	
	if (input.length > options.max)	return this.stringMaxLength[options.onFail](input, options, fullInput, fullRules);
	return input;
};
aEnsure.prototype.checks.stringMaxLength.cut = function(input, options, fullInput, fullRules) {
	if (input.length > options.max) return input.substr(0, options.max);
	return options.max;
};
aEnsure.prototype.checks.stringMaxLength.returnError = function(input, options, fullInput, fullRules) {
	var error = new aError(options.error.code, options.error.msg, input);
	return error;
};
...
// ---[[[ stringMinLength
aEnsure.prototype.checks.stringMinLength = function(input, options, fullInput, fullRules) {	
	if (input.length < options.min)	return this.stringMinLength[options.onFail](input, options, fullInput, fullRules);
	return input;
};
aEnsure.prototype.checks.stringMinLength.returnError = function(input, options, fullInput, fullRules) {
	var error = new aError(options.error.code, options.error.msg, input);
	return error;
};


module.exports = aEnsure;
